			...
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><spring:message
							code="nav.app.name" text="Inicio" /></a>
				</div>
				<div id="navbar" class="navbar-collapse collapse">
					...
					<form class="navbar-form navbar-left">
						<div class="input-group">
							...
							<label class="input-group-addon" for="buscar_curso"><span
								class=" glyphicon glyphicon-search "></span>Buscador</label> <input
								id="buscar_curso" type="text" class="form-control"
